...
export default function Home() {
  return (
    <main className="relative min-h-screen bg-obsidian">
      ...
      {/* Everything below the hero: an opaque, high-z layer so it scrolls up over
          the hero's fixed scroll-scrub layers (engine scenes go up to z-120). */}
      <div className="relative z-[130] bg-obsidian">
        <PromptSection />
        ...
        <section className="mx-auto max-w-[1200px] px-6 py-20">
          ...
          <Reveal className="mx-auto mt-10 max-w-sm rounded-[30px] bg-silver px-8 py-8 text-center text-obsidian">
            ...
            <div className="mt-2 text-[14px] text-obsidian/70">
              Use o cupom e ganhe{" "}
              <strong className="font-medium text-obsidian">10% de desconto</strong> no site
            </div>
          </Reveal>
        </section>
