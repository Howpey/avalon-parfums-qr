...
/* ============================================================================
   ...
   Vendored from github.com/oso95/scroll-world (MIT). Local tweaks:
   - section `title` is rendered as HTML (not escaped) so a Typed.js target span
     can be injected;
   - added an ESM `export` at the bottom for Next.js import.
   ----------------------------------------------------------------------------
